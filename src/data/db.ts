...
const DB: IDB = {
  menus: [
    ...
    },
    {
      ...
      type: MenuType.Simple,
      description:
        'Una selezione di birre nazionali e internazionali, perfette per ogni occasione.',
      items: [
        {
          name: 'Menabrea',
          price: 4,
          description:
            'Birra lager italiana dal gusto bilanciato e leggermente amaro.',
        },
        {
          ...
          price: 5,
          description:
            'Birra sarda non filtrata, dal corpo pieno e gusto rotondo.',
        },
        {
          ...
          price: 3,
          description:
            'Birra chiara alla spina, fresca e leggera, servita in piccolo formato.',
        },
        {
          name: 'Peroni alla spina',
          size: '0,4 litri',
          price: 6,
          description:
            'Birra chiara alla spina in formato grande, dal gusto morbido.',
        },
        {
          name: 'Nastro Azzurro',
          price: 3,
        ...
        },
        {
          ...
          price: 3.5,
          description:
            'Birra tedesca chiara, dal carattere secco e aroma luppolato.',
        },
        {
          name: 'Ceres',
          price: 4,
        ...
        },
        {
          ...
          price: 5,
          description:
            "Birra belga d'abbazia, dolce e speziata, dal colore dorato.",
        },
        {
          name: 'Leffe rossa',
          price: 5,
          description:
            'Birra rossa d’abbazia, con note caramellate e tostature leggere.',
        },
        {
          name: "Tennent's",
          price: 4,
        ...
        },
        {
          ...
          price: 5,
          description:
            'Birra di frumento tedesca, dal gusto morbido e fruttato.',
          size: '0,5 litri',
        },
        {
          name: 'Ipa',
          price: 6,
          description:
            'India Pale Ale, birra artigianale con forte luppolatura e note agrumate.',
        },
      ],
    },
    {
      ...
      type: MenuType.Simple,
      description:
        'Una selezione di aperitivi classici italiani, perfetti per iniziare la serata.',
      items: [
        {
          name: 'San Bitter',
          price: 3,
          description:
            'Aperitivo analcolico rosso, dal gusto amarognolo e rinfrescante.',
        },
        {
          name: 'Crodino',
          price: 3.5,
          description:
            'Classico aperitivo analcolico dolce-amaro, ricco di erbe aromatiche.',
        },
        {
          name: 'Crodino Twist',
          price: 4,
          description:
            'Variante fruttata del Crodino, con note di agrumi e spezie.',
        },
        {
          name: 'Campari Soda',
          price: 3.5,
          description:
            'Iconico aperitivo alcolico, amaro e frizzante, pronto da servire.',
        },
        {
          name: 'Tassoni Cedrata',
          price: 3,
          description:
            'Bevanda analcolica a base di cedro, fresca e piacevolmente agrumata.',
        },
        {
          name: 'Cocktail San Pellegrino',
          price: 3,
          description:
            'Analcolico frizzante dal gusto agrodolce, con note fruttate.',
        },
      ],
    },
    {
      ...
      subMenus: [
        {
          name: 'Gin & Tonic',
          id: 'gin-tonic',
          mainItemLabel: 'Scegli il tuo gin',
          additionalItems: [
            {
        ...
        },
        {
          ...
          id: 'cocktail-martini',
          mainItemLabel: 'Scegli il item per il tuo Martini',
          description:
            'Il classico dei classici, preparato con il gin di tua scelta e servito con olive o twist di limone',
          overPrice: 3,
        },
      ],
    },
